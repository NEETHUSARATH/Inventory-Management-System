...
const AddItem = () => {
  ...
  return (
    <Box sx={{display:"flex",backgroundColor:"#030b6b",height:1000,pt:6}}>
   
    <Container maxWidth="sm" sx={{ mt: 5 ,backgroundColor:"#fff", height:850}}>
      <form onSubmit={handleSubmit(onSubmit)}>
        <Grid container spacing={2}>
          
          <div className="container" >
            <h4 style={{ textAlign:"center", color:"#030b6b",marginTop:"4%"}}>ADD NEW ITEM</h4>
          </div>
          <Grid item xs={12}>
            <TextField

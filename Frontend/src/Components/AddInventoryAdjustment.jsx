...
const AddInventoryAdjustment = () => {
  ...
  return (
    <Box sx={{ display: "flex", backgroundColor: "#030b6b", height: 800,mt:2 }}>
   

    <Container maxWidth="sm" sx={{ mt: 8, backgroundColor:"#fff", height:500 }}>
      <form onSubmit={handleSubmit(onSubmit)}>
        <Grid container spacing={2}>
        <div className="container" >
            <h4 style={{ textAlign:"center", color:"#030b6b",marginTop:"4%"}}>INVENTORY ADJUSTMENTS</h4>
          </div>
